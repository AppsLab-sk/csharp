...
namespace BookLibrary
{
    ...
    {
        public static List<string> BookNames { get; set; } = new List<string>() { "Promile Tour", "Katechezy Pre Kazdeho", "Identita Muža", "Dugel a chrup", };
        ...
        public static List<Book> GenerateBooks()
        {
            ...
            for (int i = 0; i < BookNames.Count; i++)
            {
                ...
                var releaseDate = new DateTime(random.Next(1900,200), random.Next(1, 13), random.Next(1, 20));
