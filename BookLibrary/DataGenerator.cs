...
namespace BookLibrary
{
    ...
    {
        public static List<string> BookNames { get; set; } = new List<string>() { "Harry Humenčan", "Dano Drevo", "Promile tour", "Tancuj s ježišom","Nextcloud" };
        public static List<string> Authors { get; set; } = new List<string>() { "Humensky čert","PPPiter","Milan Nevedal","Milan Nevedal","milpet"};
        public static List<string> FirstNames { get; set; } = new List<string>() { "Ruland", "Tichomír", "Levoslav ", "Koloman", "Izidor", "Pučak" };
        public static List<string> LastNames { get; set; } = new List<string>() { "Prdlavý", "Cigáň", "Čierny","Husa","Opitý","Pripič"};
        public static List<string> Cities { get; set; } = new List<string>() { "KNM", "CA", "ZA", "MT", "LM", "DK" };
